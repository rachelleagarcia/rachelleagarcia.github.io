...
<img src="{{ '/images/blog/lame/nmapscan.jpeg' | relative_url }}" alt="nmap scan">

<p>It can take a while for the nmap scan to complete, but once it's done, here are the results:</p>

<img src="{{ '/images/blog/lame/nmapresults.jpg' | relative_url }}" alt="nmap scan">
...
<img src="{{ '/images/blog/lame/exploit.jpg' | relative_url }}" alt="found exploit">
...
<img src="{{ '/images/blog/lame/metasploit.jpg' | relative_url }}" alt="using metasploit">
...
<img src="{{ '/images/blog/lame/shell.jpg' | relative_url }}" alt="obtaining a shell">
